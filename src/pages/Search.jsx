...
const Search = () => {
    ...
    const fetchTripDetails = async () => {
        try {
            setLoading(true);
            const response = await fetch(`http://13.36.39.58:8080/travel/trips/filter/${selectedContinent}/${selectedCountry}/${selectedCity}/${minimumDuration}/${maximumDuration}/${selectedOpts}/${selectedMinPrice}/${selectedMaxPrice}`);
    ...
    useEffect(() => {
        fetch("http://13.36.39.58:8080/travel/destination/continents")
            .then(res => {
                if (!res.ok) {
        ...
        fetch("http://13.36.39.58:8080/travel/destination/countries")
            .then(res => {
                if (!res.ok) {
                    throw new Error(`HTTP error! status: ${res.status}`);
                }
        ...
        fetch("http://13.36.39.58:8080/travel/destination/cities")
            .then(res => {
                if (!res.ok) {
                    throw new Error(`HTTP error! status: ${res.status}`);
                }
