...
function CrudU() {
    ...
    const loadAll = async () => {
        try {
            console.log(token)
            const res = await fetch("http://13.36.39.58:8080/travel/users", {
                headers: {
    ...
    const create = async () => {
        ...
        try {
            const res = await fetch("http://13.36.39.58:8080/travel/auth/signup", {
                method: "POST",
                headers: {
    ...
    const findById = async () => {
        try {
            ...
            const res = await fetch(`http://13.36.39.58:8080/travel/users/${userId}`, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
